...
describe('AuthProvider', () => {
  ...
  it('keeps the session when /auth/me fails for any other reason', async () => {
    // A timeout or a 5xx says nothing about whether the token is good.
    // Clearing it here would sign people out over a momentary blip.
