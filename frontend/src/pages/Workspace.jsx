...
export default function Workspace() {
  ...
  // Pinned notes first, then most recently edited. The API sorts too, but the
  // dev mock ignores the params, so doing it here works against both.
  ...
  return (
    ...
    >
      ...
      <div className="shell__editor">
        {/* the editor needs refresh: saving changes a note's title, colour and
            pin state, and the list beside it stays mounted */}
